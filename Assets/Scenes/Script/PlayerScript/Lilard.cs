...
public class Lilard : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "d";  
    private const string PlayerPrefsColorKey = "d";  
    private const string PlayerPrefsExecuteButtonKey = "d";  
    ...
    {
        button.interactable = clickScript.Score >= 20000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 20000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 20000000 && !hasExecuted)
        {
            clickScript.Score -= 20000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
