...
public class Iverson : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "ttyyr";  
    private const string PlayerPrefsColorKey = "ttyyr"; 
    private const string PlayerPrefsExecuteButtonKey = "ttyyr"; 
    ...
    {
        button.interactable = clickScript.Score >= 1000000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 1000000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 1000000000 && !hasExecuted)
        {
            clickScript.Score -= 1000000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
