...
public class Harden : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "ty";  
    private const string PlayerPrefsColorKey = "ty";  
    private const string PlayerPrefsExecuteButtonKey = "ty";  
    ...
    {
        button.interactable = clickScript.Score >= 50000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 50000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 50000000 && !hasExecuted)
        {
            clickScript.Score -= 50000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
