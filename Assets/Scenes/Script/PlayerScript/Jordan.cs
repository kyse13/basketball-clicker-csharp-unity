...
public class Jordan : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "ttrrrttyy"; 
    private const string PlayerPrefsColorKey = "ttrrrttyy";  
    private const string PlayerPrefsExecuteButtonKey = "ttrrrttyy";  
    ...
    {
        button.interactable = clickScript.Score >= 2500000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 2500000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 2500000000 && !hasExecuted)
        {
            clickScript.Score -= 2500000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
