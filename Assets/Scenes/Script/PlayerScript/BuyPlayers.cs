...
public class BuyPlayers : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "a";  
    private const string PlayerPrefsColorKey = "a"; 
    private const string PlayerPrefsExecuteButtonKey = "a"; 
    ...
    {
        button.interactable = clickScript.Score >= 1000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 1000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 1000000 && !hasExecuted)
        {
            clickScript.Score -= 1000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
