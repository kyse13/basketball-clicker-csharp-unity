...
public class George : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "b";  
    private const string PlayerPrefsColorKey = "b";  
    private const string PlayerPrefsExecuteButtonKey = "b";  
    ...
    {
        button.interactable = clickScript.Score >= 5000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 5000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 5000000 && !hasExecuted)
        {
            clickScript.Score -= 5000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
