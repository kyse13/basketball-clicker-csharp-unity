...
public class Irving : MonoBehaviour
{
    ...
    private const string PlayerPrefsKey = "ttyy";  
    private const string PlayerPrefsColorKey = "ttyy";  
    private const string PlayerPrefsExecuteButtonKey = "ttyy";  
    ...
    {
        button.interactable = clickScript.Score >= 100000000 && !hasExecuted;
    }

    private void UpdateExecuteButtonInteractivity()
    {
        executeButton.interactable = clickScript.Score >= 100000000 && !hasExecuted;
    }
    ...
    {
        if (clickScript.Score >= 100000000 && !hasExecuted)
        {
            clickScript.Score -= 100000000;
            UpdateButtonInteractivity();
            hasExecuted = true;
            UpdateExecuteButtonInteractivity();
            UpdateTextInteractivity();
