...
public class MnoshKlikov : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        button.interactable = clickScript.Score >= 25000;
    }

    private void OnButtonClick()
    {
        if (clickScript.Score >= 25000)
        {
            clickScript.Score -= 25000;
            clickScript.startingPointsToAdd += 25;
            clickScript.UpdateText();
